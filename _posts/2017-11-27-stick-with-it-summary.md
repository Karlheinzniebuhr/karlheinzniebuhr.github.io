...
Take really small steps in the beginning. For example, if you’re planning goals for a new business, don’t plan to lock in your first customer by the end of the week. Instead, set the smaller step of meeting three potential new clients this week.
...
It has to be important to people so that they make that change.  So make sure your change is really important to you.
...
![](/assets/images/Screen-Shot-2017-11-27-at-09.46.40.png) Figure 10. The Model of SCIENCE. This figure shows the A, B, and C’s of behavior and the forces needed to change those types of behaviors. People are most aware of their behaviors during common behaviors (I show this by common behaviors having a full brain). There is a specific set of forces needed to change behaviors depending on whether it is an A, B, or C behavior. The more stars, the more important that force is to change the behavior.[/caption]
...
[Get the book](https://www.amazon.com/Stick-Scientifically-Process-Changing-Life/dp/0062692860?tag=kasbl023-20)
