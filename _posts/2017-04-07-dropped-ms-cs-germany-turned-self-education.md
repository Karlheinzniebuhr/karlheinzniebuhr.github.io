...
Ther is a good method to check for real knowledge, it is called the [Feynman technique](https://www.farnamstreetblog.com/2012/04/learn-anything-faster-with-the-feynman-technique/), and it goes like this:
**Explain what you've just learned or explained, without using the words or complex concepts you just used. You have to be able to completely rephrase the concept in your own language. For example, if you are explaining energy, you can't use the word energy. Watch [this video](https://www.youtube.com/watch?v=opqIa5Jiwuw&feature=share) for a little demo.**
...
![](/assets/images/Screen-Shot-2017-04-07-at-15.17.44-1024x669.png)
